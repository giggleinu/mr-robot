...
const CommandList: FunctionComponent<CommandListProps> = ({ commands }) => {
	return (
		<Stack className="command-list">
			// Sorry for this - I was blocked for two hours on how to bypass this typing issue
